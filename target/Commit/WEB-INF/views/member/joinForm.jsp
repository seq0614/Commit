    ...
    <section class="signup-section">
        ...
        <div class="signup-wrapper">
            <form action="/member/join" method="post">
                ...
                <!----------------------- 아이디 ---------------------->
                <c:if test="${not empty kakaoMap}">
                    <input type="hidden" value="${kakaoMap.OAUTH}" name="OAUTH">
                </c:if>
                <div
                        <c:if test="${not empty kakaoMap}">
                            class="signup-form__id signup-form disable"
                        </c:if>
                        <c:if test="${empty kakaoMap}">
                            class="signup-form__id signup-form"
                        </c:if>
                >
